...
def crawl_starting_from(url):
    ...
    with open("links_newyorker.txt", "w") as file:
            ...
            if normalized_url not in visited:
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        if ("store" not in current_url) and ("facebook" not in current_url) and ("games" not in current_url) and ("puzzle" not in current_url) and ("newyorker" in current_url):
...
# Start crawling from New Yorker
crawl_starting_from("https://www.newyorker.com/")
