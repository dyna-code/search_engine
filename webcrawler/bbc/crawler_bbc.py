...
def crawl_starting_from(url):
    ...
    with open("links_bbc.txt", "w") as file:
            ...
            if normalized_url not in visited:
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        if 'shop' not in current_url and 'advertising' not in current_url and 'contact' not in current_url and 'email' not in current_url and 'bbc.com' in current_url:
...
# Start crawling from bbc
crawl_starting_from("https://www.bbc.com/")